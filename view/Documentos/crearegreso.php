...
<div>
    <h2>Crear Recibo de Egreso de mercaderia</h2>
    <form action="addegreso.php" method="POST" validate>
        <div class="col-4">
            <div class="mb-">
                ...
                <select class="form-select" name="id_factura" aria-label="Disabled select example" required>
                    <option value="" selected>Seleccionar Factura:</option>
                    <?php foreach ($fracturas as $fractura): ?>
                            <option value="<?php echo $fractura['num_fact']; ?>"><?php echo $fractura['num_fact']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-">
                <label for="Marca" class="form-label">Bodega de egreso:</label>
                <select class="form-select" name="id_bodega" aria-label="Disabled select example" required>
            ...
            <table class="table" id="ingresoItem">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="number" name="cantidad_egreso[]" id="cantidad_egreso_1" class="form-control cantidad_egreso" autocomplete="off" min="1" step="1" required>
                    </td>
                </tr>
            </table>
        </div>
        <button type="submit" class="btn btn-primary">Guardar Recibo Egreso</button>
    </form>
</div>
</body>
</html>
